    ...
    <main className="flex flex-col items-center justify-center py-16 px-6 min-h-screen">
      ...
      >
        ...
        <p className="font-[Dosis] text-xl lg:text-4xl text-[#000000]/[.40]">
          We&apos;re excited to hear from you! Let&apos;s chat, or visit us for
          a drink!
        </p>
      </motion.div>
      ...
      <motion.div
        ...
        className="w-full max-w-2xl bg-[#FFFFFF]/[.20] p-8 rounded-2xl shadow-2xl transform hover:scale-105 transition-all duration-500"
      >
